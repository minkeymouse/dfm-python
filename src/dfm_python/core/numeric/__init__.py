...
This module contains matrix operations, covariance/variance computation,
and regularization functions for numerical stability.
"""
...
# Covariance operations constants
